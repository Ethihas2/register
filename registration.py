...
firebase = firebase.FirebaseApplication("https://login-1eb60-default-rtdb.firebaseio.com/",None)

registration_window = Tk()
registration_window.geometry("400x400")
registration_window.config(bg="lightgreen")
...
def register(): 
    ...
    encrypt_password = hashlib.md5(password.encode())
    hex_pass = encrypt_password.hexdigest()
    
    print(hex_pass)
    
    firebase.put('/',username,hex_pass)
    messagebox.showinfo("Success!","User is registered")
...
heading_label = Label(registration_window, text="Register" , font = 'arial 18 bold',bg="lightgreen")
heading_label.place(relx=0.5,rely=0.2, anchor=CENTER)

username_label = Label(registration_window, text="Username : " , font = 'arial 13',bg="lightgreen")
...
password_label = Label(registration_window, text="Password :  " , font = 'arial 13,bg="lightgreen"')
